...
class StudentPortalTests(TestCase):
    ...
    def test_presigned_upload_is_finalized_without_sending_file_through_django(self):
        ...
        with patch('platform_app.api.storj_client',return_value=fake):
